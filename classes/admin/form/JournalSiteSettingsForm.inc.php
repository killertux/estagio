...
class JournalSiteSettingsForm extends Form {
	...
	function readInputData() {
		$this->readUserVars(array('title', 'description', 'journalPath', 'enabled', 'active'));
		$this->setData('enabled', (int)$this->getData('enabled'));
		$this->setData('active', (int)$this->getData('active'));
	...
	function execute() {
		...
		$journal->setActive($this->getData('active'));
