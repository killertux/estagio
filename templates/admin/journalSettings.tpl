...
{/if}
	...
	<tr valign="top">
		<td colspan="2" class="label">
			<input type="checkbox" name="active" id="active" value="1"{if $active} checked="checked"{/if} /> <label for="active">{translate key="admin.journals.activeJournalInstructions"}</label>
		</td>
	</tr>
</table>
